        ...
        <table cellspacing="0" cellpadding="0" border="1">
            ...
            <tr>
                <td width="80%" colspan="6">
                    ...
                    {{.View.Boleto.Recipient.Address.Number}} {{.View.Boleto.Recipient.Address.Complement}}  
                    {{.View.Boleto.Recipient.Address.District}}, 
                    {{.View.Boleto.Recipient.Address.City}},
...
func getTemplateJPMorgan() (string, string) {
	return templateBoletoJPMorgan, boletoFormJPMorgan
}
